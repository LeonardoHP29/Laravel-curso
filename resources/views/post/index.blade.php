<x-blog-layout meta-Title="Blog Title" metaDescription="Blog Description">
    <div class="mx-auto mt-4 max-w-6xl">
        <h1 class="my-4 text-center font-serif text-4xl font-extrabold text-sky-600 md:text-5xl">Blog</h1>
        @auth
            <div class="flex items-center justify-center">
                <a href="{{route('post.create')}}" class="group rounded-full bg-sky-600 p-2 text-sky-100 shadow-lg duration-300 hover:bg-sky-700 active:bg-sky-800">
                    <svg
                ...
                <article class="flex flex-col overflow-hidden rounded bg-white shadow">
                    ...
                    <div class="flex-1 space-y-3 p-5">
                        ...
                        <h2 class="text-xl font-semibold leading-tight text-slate-800">
                            <a class="hover:underline" href="{{route('post.show', $post)}}">{{$post->title}}</a>
                        </h2>
                        <p class="hidden text-slate-500 md:block">
